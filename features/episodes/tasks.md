...
| T005 | [ ] | Document episode analytics workflows | Document provider evaluation, detector evaluation, downtime, and sessionisation using the final fluent API while explaining when exact span comparison remains preferable. |  | T002, T003, T004 | [`tasks/T005.md`](tasks/T005.md) |
