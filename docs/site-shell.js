(function () {
  const navigation = [
    ...
    },
    {
      ...
      links: [
        ...
        { key: "episode-analysis", label: "Episode analysis", href: "episode-analysis.html" },
        { key: "ordered-sequences", label: "Ordered sequences", href: "ordered-sequences.html" },
        { key: "live-finality", label: "Live finality", href: "concepts-live-finality.html" },
        { key: "live-operations", label: "Live stream operations", href: "live-stream-operations.html" },
  ...
  const pageKeys = new Map([
    ...
    ["episode-analysis.html", "episode-analysis"],
    ["ordered-sequences.html", "ordered-sequences"],
    ["concepts-live-finality.html", "live-finality"],
    ["live-stream-operations.html", "live-operations"],
