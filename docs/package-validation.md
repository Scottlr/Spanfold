...
```bash
unzip -l artifacts/package/Spanfold.0.1.0-preview.1.nupkg # Inspect library package contents.
unzip -l artifacts/package/Spanfold.0.1.0-preview.1.snupkg # Inspect symbol package contents.
```
...
```bash
unzip -Z1 artifacts/package/Spanfold.0.1.0-preview.1.nupkg | grep -Fx 'README.md'
unzip -Z1 artifacts/package/Spanfold.0.1.0-preview.1.nupkg | grep -Fx 'lib/net10.0/Spanfold.dll'
unzip -Z1 artifacts/package/Spanfold.0.1.0-preview.1.nupkg | grep -Fx 'lib/net10.0/Spanfold.xml'
```
